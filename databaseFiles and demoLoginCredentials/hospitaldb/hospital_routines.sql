...
--
/*!50003 DROP PROCEDURE IF EXISTS `users_in_system` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `users_in_system`(OUT doctors INT, OUT patients INT, OUT employees INT, OUT total_opd_income INT)
BEGIN
...
-- Dump completed on 2021-12-06 16:26:58
